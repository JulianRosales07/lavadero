                ...
                {customers.map((customer) => (
                  <li key={customer.id} className="px-4 py-3.5">
                    ...
                    <Button
                      ...
                      onClick={() => router.push(`/ordenes/nueva?clienteId=${customer.id}`)}
                    >
                      <Plus />
                      Nueva orden
                    </Button>
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem asChild>
                              <Link href={`/ordenes?q=${encodeURIComponent(customer.phone ?? customer.firstName)}`}>
                                <Car />
                                Ver órdenes
                              </Link>
                            </DropdownMenuItem>
